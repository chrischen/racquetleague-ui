...
external getFragmentRef:
  RescriptRelay.fragmentRefs<[> | #PkEventMessages_query]> => fragmentRef = "%identity"

@live
@inline
let connectionKey = "PkEventMessages_messagesByTopic"

%%private(
  @live @module("relay-runtime") @scope("ConnectionHandler")
  external internal_makeConnectionId: (RescriptRelay.dataId, @as("PkEventMessages_messagesByTopic") _, 'arguments) => RescriptRelay.dataId = "getConnectionID"
)
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__PkEventMessages_messagesByTopic_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
