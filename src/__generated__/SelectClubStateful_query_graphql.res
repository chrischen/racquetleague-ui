/* @sourceLoc SelectClubStateful.res */
/* @generated */
%%raw("/* @generated */")
module Types = {
  @@warning("-30")
...
external getFragmentRef:
  RescriptRelay.fragmentRefs<[> | #SelectClubStateful_query]> => fragmentRef = "%identity"
...
%%private(let makeNode = (rescript_graphql_node_SelectClubStatefulRefetchQuery): operationType => {
  ignore(rescript_graphql_node_SelectClubStatefulRefetchQuery)
  %raw(json`(function(){
var v0 = [
  "viewer",
  "adminClubs"
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": rescript_graphql_node_SelectClubStatefulRefetchQuery
    }
  },
...
let node: operationType = makeNode(SelectClubStatefulRefetchQuery_graphql.node)
