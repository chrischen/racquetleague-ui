/* @sourceLoc MatchHistoryList.res */
/* @generated */
%%raw("/* @generated */")
module Types = {
  @@warning("-30")
  ...
  type rec fragment_matches_edges_node = {
    @live id: string,
    fragmentRefs: RescriptRelay.fragmentRefs<[ | #MatchHistoryList_match]>,
  }
...
external getFragmentRef:
  RescriptRelay.fragmentRefs<[> | #MatchHistoryListFragment]> => fragmentRef = "%identity"

@live
@inline
let connectionKey = "MatchHistoryListFragment_matches"

%%private(
  @live @module("relay-runtime") @scope("ConnectionHandler")
  external internal_makeConnectionId: (RescriptRelay.dataId, @as("MatchHistoryListFragment_matches") _, 'arguments) => RescriptRelay.dataId = "getConnectionID"
)
...
%%private(let makeNode = (rescript_graphql_node_MatchHistoryListRefetchQuery): operationType => {
  ignore(rescript_graphql_node_MatchHistoryListRefetchQuery)
  %raw(json`(function(){
var v0 = [
  "matches"
],
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": rescript_graphql_node_MatchHistoryListRefetchQuery
    }
  },
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__MatchHistoryListFragment_matches_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
...
let node: operationType = makeNode(MatchHistoryListRefetchQuery_graphql.node)
