...
module Internal = {
  ...
  let fragmentConverter: Js.Dict.t<Js.Dict.t<Js.Dict.t<string>>> = %raw(
    json`{"__root":{"startDate":{"c":"Util.Datetime"},"rsvps_edges_node_user":{"f":""}}}`
  )
  @live
...
external getFragmentRef:
  RescriptRelay.fragmentRefs<[> | #EventManager_event]> => fragmentRef = "%identity"

@live
@inline
let connectionKey = "EventManager_event_rsvps"

%%private(
  @live @module("relay-runtime") @scope("ConnectionHandler")
  external internal_makeConnectionId: (RescriptRelay.dataId, @as("EventManager_event_rsvps") _, 'arguments) => RescriptRelay.dataId = "getConnectionID"
)
...
%%private(let makeNode = (rescript_graphql_node_EventManagerRsvpsRefetchQuery): operationType => {
  ignore(rescript_graphql_node_EventManagerRsvpsRefetchQuery)
  %raw(json`(function(){
var v0 = [
  "rsvps"
],
...
let node: operationType = makeNode(EventManagerRsvpsRefetchQuery_graphql.node)
