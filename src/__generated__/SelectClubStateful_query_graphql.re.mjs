...
import * as SelectClubStatefulRefetchQuery_graphql from "./SelectClubStatefulRefetchQuery_graphql.re.mjs";
...
function makeNode(rescript_graphql_node_SelectClubStatefulRefetchQuery) {
  return ((function(){
var v0 = [
  "viewer",
  "adminClubs"
...
var node = makeNode(SelectClubStatefulRefetchQuery_graphql.node);
