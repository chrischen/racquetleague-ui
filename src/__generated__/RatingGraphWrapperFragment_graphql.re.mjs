...
import * as RatingGraphWrapperRefetchQuery_graphql from "./RatingGraphWrapperRefetchQuery_graphql.re.mjs";

var Types = {};

var fragmentConverter = {"__root":{"matches_edges_node_createdAt":{"c":"Util.Datetime"}}};
...
function makeConnectionId(connectionParentDataId, activitySlug, userId) {
  ...
  return RelayRuntime.ConnectionHandler.getConnectionID(connectionParentDataId, "RatingGraphWrapperFragment_matches", args);
}
...
function makeNode(rescript_graphql_node_RatingGraphWrapperRefetchQuery) {
  return ((function(){
var v0 = [
  "matches"
],
...
var node = makeNode(RatingGraphWrapperRefetchQuery_graphql.node);
