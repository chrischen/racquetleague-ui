...
import * as MatchHistoryListRefetchQuery_graphql from "./MatchHistoryListRefetchQuery_graphql.re.mjs";
...
function makeConnectionId(connectionParentDataId, activitySlug, userId) {
  ...
  return RelayRuntime.ConnectionHandler.getConnectionID(connectionParentDataId, "MatchHistoryListFragment_matches", args);
}
...
function makeNode(rescript_graphql_node_MatchHistoryListRefetchQuery) {
  return ((function(){
var v0 = [
  "matches"
],
...
var node = makeNode(MatchHistoryListRefetchQuery_graphql.node);
