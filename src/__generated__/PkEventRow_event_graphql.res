...
external getFragmentRef:
  RescriptRelay.fragmentRefs<[> | #PkEventRow_event]> => fragmentRef = "%identity"

@live
@inline
let connectionKey = "PkEventRow_event_rsvps"

%%private(
  @live @module("relay-runtime") @scope("ConnectionHandler")
  external internal_makeConnectionId: (RescriptRelay.dataId, @as("PkEventRow_event_rsvps") _, 'arguments) => RescriptRelay.dataId = "getConnectionID"
)
