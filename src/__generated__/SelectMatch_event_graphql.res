...
external getFragmentRef:
  RescriptRelay.fragmentRefs<[> | #SelectMatch_event]> => fragmentRef = "%identity"
...
%%private(let makeNode = (rescript_graphql_node_SelectMatchRsvpsRefetchQuery): operationType => {
  ignore(rescript_graphql_node_SelectMatchRsvpsRefetchQuery)
  %raw(json`(function(){
var v0 = [
  "rsvps"
],
...
let node: operationType = makeNode(SelectMatchRsvpsRefetchQuery_graphql.node)
