...
import * as RatingListRefetchQuery_graphql from "./RatingListRefetchQuery_graphql.re.mjs";

var Types = {};

var fragmentConverter = {"__root":{"ratings_edges_node":{"f":""}}};
...
var node = makeNode(RatingListRefetchQuery_graphql.node);
