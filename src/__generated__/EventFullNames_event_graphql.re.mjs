...
import * as EventFullNamesRefetchQuery_graphql from "./EventFullNamesRefetchQuery_graphql.re.mjs";
...
function makeConnectionId(connectionParentDataId) {
  return RelayRuntime.ConnectionHandler.getConnectionID(connectionParentDataId, "EventFullNames_event_rsvps", undefined);
}
...
function makeNode(rescript_graphql_node_EventFullNamesRefetchQuery) {
  return ((function(){
var v0 = [
  "rsvps"
],
...
var node = makeNode(EventFullNamesRefetchQuery_graphql.node);
