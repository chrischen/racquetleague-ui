...
import * as PkuruSidebarClubsPaginationQuery_graphql from "./PkuruSidebarClubsPaginationQuery_graphql.re.mjs";
...
function makeConnectionId(connectionParentDataId) {
  return RelayRuntime.ConnectionHandler.getConnectionID(connectionParentDataId, "PkuruSidebarClubs_viewer_clubs", undefined);
}
...
function makeNode(rescript_graphql_node_PkuruSidebarClubsPaginationQuery) {
  return ((function(){
var v0 = [
  "clubs"
];
...
var node = makeNode(PkuruSidebarClubsPaginationQuery_graphql.node);
