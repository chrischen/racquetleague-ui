...
import * as PkEventsListRefetchQuery_graphql from "./PkEventsListRefetchQuery_graphql.re.mjs";

var Types = {};

var fragmentConverter = {"__root":{"viewer_user":{"f":""},"viewer_availability":{"f":""},"events_edges_node_startDate":{"c":"Util.Datetime"},"events_edges_node_deleted":{"c":"Util.Datetime"},"events_edges_node":{"f":""},"":{"f":""}}};
...
function makeConnectionId(connectionParentDataId, filters, afterDate) {
  ...
  return RelayRuntime.ConnectionHandler.getConnectionID(connectionParentDataId, "PkEventsListFragment_events", args);
}
...
var node = makeNode(PkEventsListRefetchQuery_graphql.node);
