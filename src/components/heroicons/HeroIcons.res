...
module Bars3Icon = {
  ...
  external make: (~className: string=?, ~\"aria-hidden": string=?) => React.element = "Bars3Icon"
}
module BellIcon = {
  @module("@heroicons/react/24/outline") @react.component
  external make: (~className: string=?, ~\"aria-hidden": string=?) => React.element = "BellIcon"
}
module XMarkIcon = {
  @module("@heroicons/react/24/outline") @react.component
  external make: (~className: string=?, ~\"aria-hidden": string=?) => React.element = "XMarkIcon"
}
