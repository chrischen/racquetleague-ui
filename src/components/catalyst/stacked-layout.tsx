...
export function StackedLayout({
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full flex-col bg-zinc-100 lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      {/* Sidebar on mobile */}
      ...
      {/* Content */}
      <main className="flex flex-1 flex-col lg:flex-row pb-2 lg:px-2">
        {children}
      </main>
    </div>
  )
