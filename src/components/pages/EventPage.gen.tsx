...
import type {queryRef as EventPageQuery_graphql_queryRef} from '../../../src/__generated__/EventPageQuery_graphql.gen';
...
export const loader: (param:LoaderArgs_t) => Promise<(null | WaitForMessages_data<EventPageQuery_graphql_queryRef>)> = EventPageJS.loader as any;
