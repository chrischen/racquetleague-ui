                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div className="flex items-center gap-2">
                      ...
                      <h2 className="text-lg font-bold text-gray-900">
                        {t`Best Doubles Partners`}
                      </h2>
                    </div>
                    <FilterTabs
                      value=bestPartnersFilter
                      onChange={filter => setBestPartnersFilter(_ => filter)}
                    />
                ...
                | _ =>
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div className="flex items-center gap-2">
                      ...
                      <h2 className="text-lg font-bold text-gray-900">
                        {t`Worst Doubles Partners`}
                      </h2>
                    </div>
                    <FilterTabs
                      value=worstPartnersFilter
                      onChange={filter => setWorstPartnersFilter(_ => filter)}
                    />
                    <div className="flex flex-col mt-2">
                      {
                        let filtered = pickEntries(
                ...
                | _ =>
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <FilterTabs
                      ...
                      onChange={filter => setBestOpponentsFilter(_ => filter)}
                    />
                    <div className="flex flex-col mt-2">
                      {
                        let filtered = pickEntries(
