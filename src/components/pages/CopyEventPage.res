...
module Query = %relay(`
  query CopyEventPageQuery($copyEventId: ID!, $locationId: ID!) {
...
type loaderData = CopyEventPageQuery_graphql.queryRef
      ...
      {() => <>
        <div
          ...
          <div className="max-w-2xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <h1 className="text-lg font-bold"> {t`Copy Event`} </h1>
            <div className="w-20" />
          </div>
        </div>
