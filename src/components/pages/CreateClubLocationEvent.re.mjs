...
import * as CreateClubLocationEventMutation_graphql from "../../__generated__/CreateClubLocationEventMutation_graphql.re.mjs";
import * as CreateClubLocationEvent_location_graphql from "../../__generated__/CreateClubLocationEvent_location_graphql.re.mjs";
import * as CreateClubLocationEvent_activities_graphql from "../../__generated__/CreateClubLocationEvent_activities_graphql.re.mjs";
...
var convertVariables = CreateClubLocationEventMutation_graphql.Internal.convertVariables;

var convertResponse = CreateClubLocationEventMutation_graphql.Internal.convertResponse;

var convertWrapRawResponse = CreateClubLocationEventMutation_graphql.Internal.convertWrapRawResponse;

var commitMutation = RescriptRelay_Mutation.commitMutation(convertVariables, CreateClubLocationEventMutation_graphql.node, convertResponse, convertWrapRawResponse);

var use = RescriptRelay_Mutation.useMutation(convertVariables, CreateClubLocationEventMutation_graphql.node, convertResponse, convertWrapRawResponse);
...
var convertFragment = CreateClubLocationEvent_location_graphql.Internal.convertFragment;

function use$1(fRef) {
  return RescriptRelay_Fragment.useFragment(CreateClubLocationEvent_location_graphql.node, convertFragment, fRef);
}

function useOpt(fRef) {
  return RescriptRelay_Fragment.useFragmentOpt(fRef !== undefined ? Caml_option.some(Caml_option.valFromOption(fRef)) : undefined, CreateClubLocationEvent_location_graphql.node, convertFragment);
}
...
var convertFragment$1 = CreateClubLocationEvent_activities_graphql.Internal.convertFragment;

function use$2(fRef) {
  return RescriptRelay_Fragment.useFragment(CreateClubLocationEvent_activities_graphql.node, convertFragment$1, fRef);
}

function useOpt$1(fRef) {
  return RescriptRelay_Fragment.useFragmentOpt(fRef !== undefined ? Caml_option.some(Caml_option.valFromOption(fRef)) : undefined, CreateClubLocationEvent_activities_graphql.node, convertFragment$1);
}
...
function CreateClubLocationEvent(props) {
...
var make = CreateClubLocationEvent;
