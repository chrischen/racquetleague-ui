...
import * as EventPageUpdateViewerRsvpMessageMutation_graphql from "../../__generated__/EventPageUpdateViewerRsvpMessageMutation_graphql.re.mjs";
...
var convertVariables$3 = EventPageUpdateViewerRsvpMessageMutation_graphql.Internal.convertVariables;

var convertResponse$3 = EventPageUpdateViewerRsvpMessageMutation_graphql.Internal.convertResponse;

var convertWrapRawResponse$3 = EventPageUpdateViewerRsvpMessageMutation_graphql.Internal.convertWrapRawResponse;

var commitMutation$2 = RescriptRelay_Mutation.commitMutation(convertVariables$3, EventPageUpdateViewerRsvpMessageMutation_graphql.node, convertResponse$3, convertWrapRawResponse$3);

var use$3 = RescriptRelay_Mutation.useMutation(convertVariables$3, EventPageUpdateViewerRsvpMessageMutation_graphql.node, convertResponse$3, convertWrapRawResponse$3);

var EventPageUpdateViewerRsvpMessageMutation = {
  Operation: undefined,
  Types: undefined,
                                                                            ...
                                                                            children: [
                                                                              JsxRuntime.jsxs("div", {
                                                                                    children: [
                                                                                      ...
                                                                                      JsxRuntime.jsxs("div", {
                                                                                            children: [
                                                                                              Core__Option.getOr(Core__Option.map($$event.viewerHasRsvp, (function (has) {
                                                                                                          if (has) {
                                                                                                            return JsxRuntime.jsx(Event$Message, {
                                                                                                                        eventId: $$event.id
                                                                                                                      });
                                                                                                          } else {
                                                                                                            return null;
...
export {
  ...
  EventPageUpdateViewerRsvpMessageMutation ,
  Message ,
  sessionContext ,
  make ,
  $$default as default,
