...
function EventItem(props) {
  ...
  var showActions = match$1[0];
  var match$2 = use$1();
  var commitJoin = match$2[0];
  var match$3 = use$3();
  var commitLeave = match$3[0];
  ...
  return JsxRuntime.jsxs("div", {
              children: [
                JsxRuntime.jsxs(Layout.Container.make, {
                      ...
                      className: Core$1.cx("relative flex items-center space-x-4 py-4 cursor-pointer select-none")
                    }),
                showActions ? JsxRuntime.jsx("div", {
                        className: "absolute inset-0 bg-white/60 pointer-events-none transition-opacity"
                      }) : null,
                JsxRuntime.jsx("div", {
                      ...
                      className: Core$1.cx("absolute top-0 right-0 h-full w-4/5 sm:w-4/5 md:w-2/3 bg-white/95 backdrop-blur border-l border-gray-200", "flex px-4 py-2 transition-transform duration-150 ease-in-out z-20", showActions ? "translate-x-0 shadow-[-4px_0_8px_-2px_rgba(0,0,0,0.15)]" : "translate-x-full"),
                      onClick: (function (e) {
                          e.stopPropagation();
                        })
                    })
