...
var getConnectionNodes = SelectMatch_event_graphql.Utils.getConnectionNodes;
...
function SelectMatch(props) {
  var onMatchSelected = props.onMatchSelected;
  ...
  var players = getConnectionNodes(match$2.data.rsvps);
  var matchSelected = function (match) {
    if (match[0].length !== 2 || match[1].length !== 2) {
      return ;
    } else {
      return onMatchSelected(match);
    }
  };
                        ...
                        JsxRuntime.jsxs("section", {
                              children: [
                                ...
                                JsxRuntime.jsx(SelectMatch$SelectEventPlayersList, {
                                      event: $$event,
                                      selected: Core__Array.filterMap(leftNodes, (function (n) {
                                              return n.user;
                                            })),
                      ...
                      children: [
                        JsxRuntime.jsxs("section", {
                              children: [
                                ...
                                JsxRuntime.jsx(SelectMatch$SelectEventPlayersList, {
                                      event: $$event,
                                      selected: Core__Array.filterMap(rightNodes, (function (n) {
                                              return n.user;
                                            })),
                                      disabled: Core__Array.filterMap(leftNodes, (function (n) {
                                              return n.user;
                                            })),
