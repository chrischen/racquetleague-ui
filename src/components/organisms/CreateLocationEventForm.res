          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <FormSection
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <EventTagInput.TagGroup
                  tags={["rec", "comp"]}
                  selectedTags
                  onTagsChange={tags => setSelectedTags(_ => tags)}
                  category=#"type"
                  label={ts`type of event`}
                  description={ts`Select tags that best describe this event`}
                />
                <EventTagInput.TagGroup
                  tags={["all level", "3.0+", "3.5+", "4.0+", "4.5+", "5.0+"]}
                  selectedTags
                  onTagsChange={tags => setSelectedTags(_ => tags)}
                  category=#level
                  label={ts`level of play`}
                />
