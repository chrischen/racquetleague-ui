  ...
  let navigation = [
    {
      name: ts`Rankings`,
      href: "/",
      current: pathname->String.indexOf("/league") > -1 || pathname == "/" ? true : false,
    },
    {
      name: ts`Find Games`,
      href: "/play",
      current: pathname->String.indexOf("/play") > -1 ? true : false,
    },
    {
      name: ts`About`,
      href: "/about",
