...
import * as CreateClubLocationMutation_graphql from "../../__generated__/CreateClubLocationMutation_graphql.re.mjs";
...
var convertVariables = CreateClubLocationMutation_graphql.Internal.convertVariables;

var convertResponse = CreateClubLocationMutation_graphql.Internal.convertResponse;

var convertWrapRawResponse = CreateClubLocationMutation_graphql.Internal.convertWrapRawResponse;

var commitMutation = RescriptRelay_Mutation.commitMutation(convertVariables, CreateClubLocationMutation_graphql.node, convertResponse, convertWrapRawResponse);

var use = RescriptRelay_Mutation.useMutation(convertVariables, CreateClubLocationMutation_graphql.node, convertResponse, convertWrapRawResponse);

var CreateClubLocationMutation = {
  Operation: undefined,
  Types: undefined,
...
function CreateClubLocation(props) {
...
var make = CreateClubLocation;

export {
  ts ,
  isEmptyObj ,
  parseData ,
  CreateClubLocationMutation ,
  sessionContext ,
  ControllerOfInputs ,
  schema ,
  make ,
