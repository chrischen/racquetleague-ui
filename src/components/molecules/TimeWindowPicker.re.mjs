...
import * as CourtAvailabilityBandOverlay from "./CourtAvailabilityBandOverlay.re.mjs";
...
function TimeWindowPicker$WindowChip(props) {
  ...
  return JsxRuntime.jsxs("div", {
              children: [
                ...
                JsxRuntime.jsx("span", {
                      children: widthPct > 18.0 ? TimeWindow.hourLabelIntl(intl, intent.start) + "–" + TimeWindow.hourLabelIntl(intl, intent.end) : Js_math.floor_int(duration).toString() + "h",
