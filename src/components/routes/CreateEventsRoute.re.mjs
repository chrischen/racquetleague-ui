...
import * as CreateEventsPage from "../pages/CreateEventsPage.re.mjs";
...
function loadMessages(lang) {
  var tmp = lang === "ja" ? import("../../locales/src/components/pages/CreateEventsPage.re/ja") : import("../../locales/src/components/pages/CreateEventsPage.re/en");
...
async function loader(param) {
  ...
  var query = CreateEventsPageQuery_graphql.load(RelayEnv.getRelayEnv(param.context, import.meta.env.SSR), {}, "store-or-network", undefined, undefined);
...
var Component = CreateEventsPage.make;
