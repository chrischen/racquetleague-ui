...
let loadMessages = Lingui.loadMessages({
  ...
  ko: Lingui.import("../../locales/src/components/pages/UpdateLocationEventPage.re/ko"),
  vi: Lingui.import("../../locales/src/components/pages/UpdateLocationEventPage.re/vi"),
})
