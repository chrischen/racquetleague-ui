...
var loadMessages = Lingui.loadMessages({
      en: import("../../locales/src/components/pages/ClubEventsListPage.re/en"),
      ja: import("../../locales/src/components/pages/ClubEventsListPage.re/ja"),
      th: import("../../locales/src/components/pages/ClubEventsListPage.re/th"),
      zhTW: import("../../locales/src/components/pages/ClubEventsListPage.re/zh-TW"),
      zhCN: import("../../locales/src/components/pages/ClubEventsListPage.re/zh-CN"),
      ko: import("../../locales/src/components/pages/ClubEventsListPage.re/ko"),
      vi: import("../../locales/src/components/pages/ClubEventsListPage.re/vi")
    });
...
var Component = ClubEventsListPage.make;
