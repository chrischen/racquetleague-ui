...
@genType
let \"Component" = CreateClubEventsPage.make
...
let loadMessages = Lingui.loadMessages({
  ...
  ko: Lingui.import("../../locales/src/components/pages/CreateClubEventsPage.re/ko"),
  vi: Lingui.import("../../locales/src/components/pages/CreateClubEventsPage.re/vi"),
})

@genType
let loader = async ({context, params}: LoaderArgs.t) => {
  let query = CreateClubEventsPageQuery_graphql.load(
